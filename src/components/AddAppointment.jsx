...
const BookAppointment = () => {
    ...
    const handlePopulate = async () => {
        if (!buyerId) return;
        try {
            const response = await axios.get(`http://backend-service:4495/buyer/get/${buyerId}`);
    ...
    const handlePropertyValidation = async () => {
        ...
        try {
            const response = await axios.get(`http://backend-service:4495/property/${propertyId}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.get('http://backend-service:4495/appointments/getAll');
            ...
            const appointmentResponse = await axios.post('http://backend-service:4495/appointments/create', appointment);
